function App() {
    ...
    function submitButtonClicked(event) {
        ...
        let name = $('.team').val();
        let Team = $('.teamText1');
        Team.append(`<div class="col m6"><div class="card indigo darken-4"><div class="card-content white-text">
      <span class="card-title scoreBoard1"><p>` + $('.team').val().toUpperCase() + ` Team Crimes: </p><span>`);
    ...
    function useLookUp(data) {
        ...
        $('.team').val('');
        let codeLookUp = data[0].team_code;
    ...
    function displayPlayers(data) {
        ...
        for (let i = 0; i < data.length; i++) {
            let Name = `<div class="col m6"><div class="card indigo darken-4"><div class="card-content white-text">
                      <span class="card-title">` + data[i].Name + `</span><p class="player_name">Date: ` + data[i].Date + `</p>
                      <p>Charge: ` + data[i].Category + `</p><p class="truncate details details' + [i] + '">Details: ` + data[i].Description + `</p></div></div></div></div>`;
    ...
    function displayTeam(data) {
        for (let i = 0; i < data.length; i++) {
            let teamCrimes = '<p>' + data[i].Category + ': ' + data[i].arrest_count + '</p>';
    ...
    function compareClicked() {
        ...
        let Team = $('.teamText1');
        Team.append(`<div class="col m6"><div class="card indigo darken-4"><div class="card-content white-text">
      <span class="card-title scoreBoard2"><p>` + $('.team').val().toUpperCase() + ` Team Crimes: </p><span>`);
    ...
    function displayScoreboard() {
        $('.scoreboard').append(`<div class="col m12"><div class="card indigo darken-4"><div class="card-content white-text">
      <span class="card-title moralScoreboard"><h4>You are Morally Superior in the following areas:</h4><span>`);
